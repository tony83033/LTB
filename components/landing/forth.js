  ...
  <div className="lg:grid lg:grid-cols-12 lg:gap-x-6">
    <div className="px-4 py-10 lg:col-span-5 lg:px-0">
      ...
      <h1 className="text-lg p-2 font-bold md:text-5xl">
        How outsourcing personal injury services can help your business?
      </h1>
      <p className="mt-8 font-medium">
        Outsourcing your legal personal injury requirements to The Legal Base
        lowers your operational costs, which benefits from labour arbitrage,
        greater scale efficiency, and superior IT systems.
      </p>
      ...
      <div className="w-full p-5 md:w-1/2">
        <div className="rounded-md border bg-white bg-opacity-90">
          ...
          <li class="flex items-center">
            ...
            <p className=" leading-relaxed -500 font-semibold leading-normal">
              Personal injury, as opposed to property damage, is legal phrase
              for an injury to the body, mind, or emotions, IN common-law
              jurisdictions, the word most usually refer to a sort of tort
              litigation in which the individual initiating the complaint has
              suffered bodily or mental injury.
            </p>
