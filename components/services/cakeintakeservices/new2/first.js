  ...
  <div className="relative w-full bg-white">
    <div className="mx-auto max-w-7xl lg:px-8">
      <div className="flex flex-col justify-center px-4 py-10 lg:px-6">
        ...
        The Legal Base LPO is a leading legal intake service provider and has helped several attorneys and practices grow their businesses and be successful in the competitive marketplace. We provide high-quality legal intake solutions that are customised to your exact needs and requirements.
  ...
  <div className="mx-auto my-12 max-w-7xl px-4 sm:px-6 md:my-24 lg:my-32 lg:px-8">
    <div className="mx-auto max-w-xl text-center">
      <div className="mx-auto inline-flex rounded-full bg-gray-100 px-4 py-1.5">
        ...
        The Legal Base LPO has a team of experts who have rich experience of providing case intake services to law firms and attorneys. 
    ...
    <div className="mt-12 grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
      ...
      <div>
        ...
        <h3 className="mt-8 text-lg font-semibold text-black">Enhanced Efficiency and Productivity: 
</h3>
        <p className="mt-4 text-sm text-gray-600">
        Outsourcing case intake services to TLB will streamlines the intake process, resulting in increased efficiency and productivity. TLB leverages technology and automation tools to streamline data collection, organization, and reporting, reducing manual effort and improving overall workflow.
