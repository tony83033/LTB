  ...
  <div className="mx-auto max-w-7xl py-10">
    <div>
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-sm leading-6  font-semiboldtracking-wide text-black-500">
      ...
      <div className="mt-6 grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 lg:gap-6">
        <div className="rounded-md border border-black/30 p-6">
          ...
          <dd className="mt-2 text-sm text-black-500">
          Outsourcing to TLB can ensure a prompt response to potential clients. By having a dedicated team managing initial inquiries, law firms can provide timely and professional communication, enhancing the overall client experience and satisfaction.
