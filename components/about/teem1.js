      ...
      <div className="w-full space-y-12 lg:w-1/2 ">
        ...
        <div className="md:flex md:items-start md:-mx-4">
          ...
          <div className="mt-4 md:mx-4 md:mt-0">
            ...
            TLB has over 70+ experienced attorneys recruited from Indias best Law Schools and with exposure of working with some of the leading LPOs. Their skills and knowledge are harnessed through continuous education and training by our strategic business unit. ​
        ...
        <div className="md:flex md:items-start md:-mx-4">
          ...
          <div className="mt-4 md:mx-4 md:mt-0">
            ...
            <p className="mt-3 text-gray-500 dark:text-gray-300">
            We have the capabilities of scaling up the resources at a short notice. We operate an on-bench policy with a large number of subject matter experts and resources by paying retainer fees in return of their commitment for coming on board immediately besides maintaining the updated database of available attorneys. They remain available to us and can be deployed as per the requirements of our client in a minimal turn around time.
