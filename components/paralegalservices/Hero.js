...
<React.Fragment>
        ...
        <div className="relative  sm:w-5/6 w-full md:w-5/6 lg:5/6  mx-auto dark:bg-[#1E293B] bg-white" >
  <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
    <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
      ...
      <h1 className="mt-8 text-3xl font-bold tracking-tight text-black dark:text-white md:text-4xl lg:text-6xl">
 Outsourced Paralegal Services

      </h1>
      <p className="mt-8 text-lg font-bold text-gray-700 dark:text-white">
...
<br>
      ...
      <form action="" className="mt-8 flex items-start space-x-2">
        <div>
          <input
            className="flex w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm placeholder:text-gray-600 dark:placeholder:text-white focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
            type="email"
