   ...
   <React.Fragment>
	...
	<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		<div data-aos="fade-down">
			<h2 className="text-xl font-semibold tracking-tight text-center sm:text-5xl dark:text-gray-50 ">Here are some common paralegal services which are typically outsourced to TLB:
</h2>
...
<section className="dark:bg-gray-800 dark:text-gray-100 m-4" data-aos="zoom-in">
